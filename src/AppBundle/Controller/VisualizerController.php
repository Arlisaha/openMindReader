...
class VisualizerController extends Controller
{
    public function htmlAction($fileName)
    {
		...
		$callback = function($fullName, $options = null){//$this->get('assets.packages')
			...
			[
				...
				GenericHTMLConverter::MAIN_ICON_KEY => [
					...
					GenericHTMLConverter::PATH_ICON_KEY    => [
						...
						GenericHTMLConverter::OPTIONS_PATH_ICON_KEY  => [$this->get('assets.packages'), $this->container->getParameter('app.assets.output')],
					],
				],
			]
		);
